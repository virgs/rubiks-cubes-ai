...
Since all the algorithms run against this cube, we cut down the branching to 6 (3 faces, 2 directions). One could even claim that *R'* is the same *3R*, as, in fact, it is. It would make the branching factor even smaller (3 faces, one direction), but the solutions found would be even farther from the optimal one.
...
To generate the report, **15 executions** of a pocket cube scrambled with **30 random moves** were executed.   
...
| GA | 65.827 (235.016, 8.027, 51.192) | 309.706 | - | 2.295 | - | Pre-defined |
| SA | 64.671 (250.181, 2.315, 60.22) | 304.27 | - | 2.436 | - | Pre-defined |
